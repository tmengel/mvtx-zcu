...
//#include "..\ssfifo_4endpoints.cydsn\cyfxgpif2config.h"
...
CyU3PDmaChannel glChHandleConsumerFifo; /* DMA Channel handle for U2P transfer. */
CyU3PDmaChannel glChHandleProducerFifoA; /* DMA Channel handle for P2U transfer. */
CyU3PDmaChannel glChHandleProducerFifoB; /* DMA Channel handle for P2U transfer. */
CyU3PDmaChannel glChHandleProducerFifoC; /* DMA Channel handle for P2U transfer. */
...
void CyFxSlFifoApplnStart(void) {
	...
	apiRetStatus = CyU3PDmaChannelCreate(&glChHandleConsumerFifo,
			CY_U3P_DMA_TYPE_AUTO/*CY_U3P_DMA_TYPE_MANUAL*/, &dmaCfg);
	if (apiRetStatus != CY_U3P_SUCCESS) {
	...
	apiRetStatus = CyU3PDmaChannelCreate(&glChHandleProducerFifoA,
			CY_U3P_DMA_TYPE_AUTO/*CY_U3P_DMA_TYPE_MANUAL*/, &dmaCfg);
	if (apiRetStatus != CY_U3P_SUCCESS) {
		CyU3PDebugPrint(4, "CyU3PDmaChannelCreate failed, Error code = %d\n",
				apiRetStatus);
	...
	dmaCfg.cb = 0;	//CyFxSlFifoPtoUDmaCallback;
	apiRetStatus = CyU3PDmaChannelCreate(&glChHandleProducerFifoB,
			CY_U3P_DMA_TYPE_AUTO/*CY_U3P_DMA_TYPE_MANUAL*/, &dmaCfg);
	if (apiRetStatus != CY_U3P_SUCCESS) {
		CyU3PDebugPrint(4, "CyU3PDmaChannelCreate failed, Error code = %d\n",
				apiRetStatus);
	...
	dmaCfg.cb = 0;	//CyFxSlFifoPtoUDmaCallback;
	apiRetStatus = CyU3PDmaChannelCreate(&glChHandleProducerFifoC,
			CY_U3P_DMA_TYPE_AUTO/*CY_U3P_DMA_TYPE_MANUAL*/, &dmaCfg);
	if (apiRetStatus != CY_U3P_SUCCESS) {
		CyU3PDebugPrint(4, "CyU3PDmaChannelCreate failed, Error code = %d\n",
				apiRetStatus);
	...
	apiRetStatus = CyU3PDmaChannelSetXfer(&glChHandleConsumerFifo,
...
void CyFxSlFifoApplnInit(void) {
	...
	if (apiRetStatus != CY_U3P_SUCCESS) {
		CyU3PDebugPrint(4,
				"CyU3PSetGpioDriveStrength Failed, Error code = %d\n",
				apiRetStatus);
		CyFxAppErrorHandler(apiRetStatus);
	}
